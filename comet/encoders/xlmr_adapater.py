...
from transformers.adapters import XLMRobertaAdapaterModel

from comet.encoders.base import Encoder
from comet.encoders.bert import BERTEncoder


class XLMREncoderAdapters(BERTEncoder):
    ...
    def __init__(
        ...
        if load_pretrained_weights:
            self.model = XLMRobertaAdapaterModel.from_pretrained(
                pretrained_model, add_pooling_layer=False
            )
        else:
            self.model = XLMRobertaAdapaterModel(
    ...
    def from_pretrained(
        ...
        """
        return XLMREncoderAdapters(pretrained_model, load_pretrained_weights)
